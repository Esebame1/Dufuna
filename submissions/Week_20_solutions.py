I would need to get an input from the use for his or her courses and their units so as to get the the cummulative gp and the cgpa depending on the number of semesters inputed by the user.
